...
public class PanelConfiguracionProcesos extends JDialog implements
	...
	public PanelConfiguracionProcesos(
			Simulador _simuladorPadre) {

		super(_simuladorPadre, true); 
		simuladorPadre = _simuladorPadre; 
		...
		btnConfigurar.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent arg0) {
				if (txtFieldBloqueadoCamp1.getText().equals("")
					...
					simuladorPadre.setVectorBurst(vectorBurst);
					simuladorPadre.setVectorLlegada(vectorLlegada);
					simuladorPadre.setVectorBloqueado(vectorBloqueado);
					setVisible(false);
					dispose();
				}
			}
