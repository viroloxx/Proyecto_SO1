...
public final class StdRandom {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N; i++) {
      	  System.out.println("Uniforme [0,100] " + uniform(100));
      	  System.out.println("Uniforme [10.0,99.0] " + uniform(10.0, 99.0));
      	  System.out.println("Exponencial " + exp(11.5));
      	  System.out.println("Normal " + gaussian(9.0, 0.2));
        }
    }
}